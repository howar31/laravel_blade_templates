...
3. The templates are now in `resource\assets`, and controllers are in `app\Http\Controllers`, and routes are in `routes\web.php`.
4. The templates are now ready to use!
