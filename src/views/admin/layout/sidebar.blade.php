		...
		<ul>
			...
			<li class="sidebar-group">
				...
				<ul class="sidebar-group-content">
					...
					<li class="sidebar-item"><a href="javascript:void(0);"><i class="fas fa-user"></i> Grids</a></li>
					<li class="sidebar-item"><a href="javascript:void(0);"><i class="fas fa-user"></i> Modals</a></li>
					<li class="sidebar-item"><a href="javascript:void(0);"><i class="fas fa-user"></i> Tables</a></li>
					<li class="sidebar-item"><a href="javascript:void(0);"><i class="fas fa-user"></i> Toasts</a></li>
					<li class="sidebar-item"><a href="javascript:void(0);"><i class="fas fa-user"></i> Panels</a></li>
					<li class="sidebar-item"><a href="javascript:void(0);"><i class="fas fa-user"></i> Progress Bars</a></li>
